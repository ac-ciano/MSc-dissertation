...
# Configuration
MODEL_DIR = "models/roberta_softf1_finetuned"  # Relative to workspace root
TEST_DATA_PATH = "data/test_set.csv" # Relative to workspace root
TEST_METRICS_CSV_FILENAME = "roberta-base_softf1_test_metrics.csv" # CSV for test metrics
