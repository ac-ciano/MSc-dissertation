...
NEW_DATA_CSV_PATH = r"F:\VERO UTENTE\Desktop\Uni\dissertation\main\data\posts_without_labels.csv"
OUTPUT_CSV_PATH = r"F:\VERO UTENTE\Desktop\Uni\dissertation\main\K-fold\large-cross-entropy--5e-5\data_fold1\SECOND\SECOND_pseudol_{PREFIX}.csv"
