...
OUTPUT_CSV_PATH = os.path.join(r"F:\VERO UTENTE\Desktop\Uni\dissertation\main\K-fold\large-cross-entropy--5e-5", f"data_fold{fold}\FIRST", f"FIRST_pseudol_{PREFIX}.csv")
