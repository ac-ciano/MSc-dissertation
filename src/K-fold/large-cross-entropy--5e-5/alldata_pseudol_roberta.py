...
PREFIX = "alldata"                 # Prefix used when saving the model in the training script
...
SAVED_MODEL_SUBDIR_NAME = f"final_model_epoch_{NUM_TRAIN_EPOCHS}"
MODEL_ADAPTER_PATH = os.path.join(MODEL_PATH_ROOT, f"models_{PREFIX}", SAVED_MODEL_SUBDIR_NAME)
...
OUTPUT_CSV_PATH = os.path.join(SCRIPT_DIR, f"pseudol_output_{PREFIX}.csv")
